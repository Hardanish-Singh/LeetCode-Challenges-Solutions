...
JOIN Employee   AS emp ON emp.departmentId = SubQuery.dept AND emp.salary = SubQuery.maxsalary
JOIN Department AS departments ON departments.id = SubQuery.dept
