/*
        You are given a 0-indexed integer array nums and an integer pivot. Rearrange nums such that the following conditions are satisfied:
                ...
                3) The relative order of the elements less than pivot and the elements greater than pivot is maintained.
                        a) More formally, consider every p(i), p(j) where p(i) is the new position of the i^th element and p(j) is the new position of the j^th element. 
                           For elements less than pivot, if i < j and nums[i] < pivot and nums[j] < pivot, then p(i) < p(j). 
                           Similarly for elements greater than pivot, if i < j and nums[i] > pivot and nums[j] > pivot, then p(i) < p(j).
